...
(NULL,'John','Smith','555882121','1','1',0,'1000 N. 4th St.','PO Box 23','Fairfield', 'IA','52557','1000 N. 4th St.','PO Box 23','Fairfield', 'IA','52557','John','01/31/2020','MasterCard','5555666655556666');
INSERT INTO Customer VALUES
(NULL,'Jim', 'Jacob','515282426','2','2',1,  '40 N. 4th St.',   NULL,    'Fairfield', 'IA','52556','40 N. 4th St.',  NULL,       'Fairfield', 'IA','52556','James','04/30/2022','Visa','4444666633336666');
...
INSERT INTO AltAddress VALUES
(NULL,1,"101 N COURT", "FAIRFIELD","IA","52556", 1, 1);
INSERT INTO AltAddress VALUES
(NULL,1,"59 BEETLE", "PALO ALTO","CA","94301", 1, 1);
INSERT INTO AltAddress VALUES
(NULL,2,"5 ADAMS", "FAIRFIELD","IA","52556", 1, 0);
INSERT INTO AltAddress VALUES
(NULL,1,"159 HARRISON", "FAIRFIELD","IA","52556", 0, 1);
INSERT INTO AltAddress VALUES
(NULL, 2,"33 TERENCE DR", "PALO ALTO","CA","94301", 0, 1);
INSERT INTO AltAddress VALUES
(NULL, 1,"1 MAIN", "CHICAGO","IL","63605", 0, 1);


SELECT c.custid, c.fname, c.lname, a.* FROM Customer c, AltAddress a WHERE c.custid = a.custid;




#create AccountsDb.AltPayment

CREATE TABLE AltPayment (
...
INSERT INTO AltPayment VALUES
(NULL,1,"10/10/2020", "MasterCard","5234432156788765");
INSERT INTO AltPayment VALUES
(NULL,1,"10/01/2018", "Visa","1233466156999876");
INSERT INTO AltPayment VALUES
(NULL,2,"5/10/2025", "Visa","1434437156788765");

SELECT c.custid, c.fname, c.lname, a.* FROM Customer c, AltPayment a WHERE c.custid = a.custid;
